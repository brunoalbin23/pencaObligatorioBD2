...
app.post('/crearCuenta', (req, res) => {
    ...
    cuentas.forEach((elemento) => {
        if (elemento.gmail == req.body.gmail) { //aca me compara gmail con gmail
            console.log("LA CUENTA " + req.body.gmail + " YA EXISTE");
            console.log("Este es el body:");
            console.log(req.body);
            console.log(req.body.gmail + " --- " + req.body.pass + " y el gmail es " + elemento.gmail); //si pongo mail en vez de gmail sale undefinded y lo mismo si pongo password en vez de pass(pass es al buena)
